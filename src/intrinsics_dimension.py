...
def mle_id(data : torch.Tensor, k, averaging_of_inverses : Optional[bool] = True) -> float:
    ...
    Parameters:
        ...
        * averaging_of_inverses : bool (default=False), Use the mean ([1]) or the inverse of the mean of the inverses ([2])
...
if __name__ == "__main__":
    ...
    d1 = mle_id(data, k=n-1, averaging_of_inverses = False)
    d2 = mle_id(data, k=n-1, averaging_of_inverses = True)
